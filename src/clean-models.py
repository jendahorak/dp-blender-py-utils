...
def process_objects_terrain():
    ...
    terrain_objects = [obj for obj in bpy.context.selected_objects if 'terrain' in obj.name.lower()]
    ...
    bpy.context.view_layer.objects.active = [obj for obj in bpy.context.selected_objects if obj not in terrain_objects][0]
